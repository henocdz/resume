...
\begin{entrylist}
    ...
    \entry
        ...
        {\\
            ...
            the design of each of these processes. I also designed and implemented the engineering 
            career paths which helped to keep a low rotation rate - this initiative was later
    ...
    \entry
        ...
        {\\
            ...
            \begin{itemize}
                ...
                \item Openings Locator: a system leveraging Postgres' full-text search, trigram similarity and Levenshtein capabilities to allow chat-users to search for locations where there are openings available in a conversational way (natural language).
