...
\begin{entrylist}
    \entry
        ...
        {\\
            ...
            I reduced the API response time by 5x by leveraging Postgres optimizations such as 
            indexes and cluster configuration.

            I also led and contributed to the design and implementation of a auto-posting project
    ...
    \entry
        ...
        {\\
            ...
            \begin{itemize}
                ...
                \item CI \& CD Pipelines Team City
                \item Hiring, recuiting, and onboarding processes
                \item Engineering processes, performace reviews, and career paths
            \end{itemize}       
        }
