...
\begin{minipage}[t]{1\textwidth} % 40% of the page width for the introduction text
    {  
        ...
        I have a diverse background and experience having worked with Go, Python, JavaScript and 
        cloud-native technologies such as AWS, Docker, Terrafor, and GCP. I have a strong 
        interest in software design and architecture, product, and mentoring. \\ 
